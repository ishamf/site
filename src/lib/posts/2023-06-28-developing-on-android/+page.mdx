...
Depending on what you're doing, coding in android seems to be completely feasible, though it still have some problems.
It will probably remain as something you can do in a pinch, not really something you'd want to do if you have other alternatives.
